/**
 * Original asset form: grouped Fieldsets with all sections visible.
...
export function AssetFormDialogDefault(props: AssetFormDialogBodyProps) {
  const {
    onSubmitForm,
    saving,
    editingId,
            ...
            <div className="flex flex-column gap-2 flex-1 min-w-0 xl:max-w-[26rem]">
              ...
              >
                <p className="text-xs text-color-secondary mt-0 mb-2">
                  Drag and drop an image here, or choose a file. JPEG, PNG, WebP,
                  or GIF. Max 2 MB on save.
                </p>
                <input
