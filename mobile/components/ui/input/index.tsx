...
import { RNPressable, RNTextInput, RNView } from '@/lib/rnJsx';
import {
  tva,
  type VariantProps,
  useStyleContext,
...
const UIInput = createInput({
  Root: withStyleContext(RNView, SCOPE),
  Icon: UIIcon,
  Slot: RNPressable,
  Input: RNTextInput,
});

/** Gluestack creator types omit NativeWind `className`; compound `ComponentProps` is unreliable. */
type NwProps = Record<string, unknown> & { className?: string };
const UIInputRoot = UIInput as React.ComponentType<NwProps>;
const UIInputIcon = UIInput.Icon as React.ComponentType<NwProps>;
const UIInputSlot = UIInput.Slot as React.ComponentType<NwProps>;
const UIInputField = UIInput.Input as React.ComponentType<NwProps>;
