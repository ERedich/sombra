/**
 * Gluestack UI `data-*` variant ordering for Tailwind (CJS).
 * Mirrors @gluestack-ui/nativewind-utils/tailwind-plugin so Tailwind 3 + Node can load it.
 */
...
function getStatesWeight(state) {
